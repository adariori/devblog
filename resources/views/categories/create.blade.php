<x-layout titre="Nouvelle catégorie">
    ...
    <div class="mx-auto max-w-md">
        <header class="border-b-2 border-zinc-900 pb-6">
            ...
            <h1 class="mt-2 font-serif text-3xl font-semibold tracking-tight text-zinc-900">Nouvelle catégorie</h1>
        </header>

        <form action="{{ route('categories.store') }}" method="POST" class="mt-8 space-y-6">
            @csrf
